...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    portfolio: [
      { title: "K'tsu.",
              image: "/servicios/residencial/ktsu/portada.png",
        year: "2025",
        location: "Valencia, Carabobo",
        description:
          "Diseño y visualización de habitación integrando calidez, equilibrio espacial y una ambientación cuidada en cada detalle.",
        images: [
          "/servicios/residencial/ktsu/01.png",
          "/servicios/residencial/ktsu/02.png",
          "/servicios/residencial/ktsu/03.png",
          "/servicios/residencial/ktsu/04.png",
          "/servicios/residencial/ktsu/05.png",
          "/servicios/residencial/ktsu/06.png",
          "/servicios/residencial/ktsu/07.png",
        ],
      },
